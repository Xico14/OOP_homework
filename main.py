...
student_1 = Student('Евгений', 'Антонов', 'Male')
student_1.finished_courses = ['Python', 'Git']
student_1.courses_in_progress = ['JavaScript', 'Введение в программирование']

student_2 = Student('Иван', 'Корольков', 'Male')
student_2.finished_courses = ['С#', 'Git']
student_2.courses_in_progress = ['Python для тех у кого лапки', 'Unity']
students_list = [student_1, student_2]

lecturer_1 = Lecturer('Ислам', 'Наримов')
lecturer_1.courses_attached = ['Python', 'JavaScript']

lecturer_2 = Lecturer('Евгений', 'Шипилов')
lecturer_2.courses_attached = ['Python', 'C#']
lecturer_list = [lecturer_1, lecturer_2]

reviewer_1 = Reviewer('Александр', 'Иванов')
reviewer_1.courses_attached = ['Python', 'С#', 'JavaScript', 'Git']
...
reviewer_1.rate_hw(student_1, 'JavaScript', 9)
...
reviewer_2.rate_hw(student_2, 'JavaScript', 4)
...
student_1.rate_lecturer(lecturer_1, 'JavaScript', 8)

student_2.rate_lecturer(lecturer_1, 'JavaScript', 10)
student_2.rate_lecturer(lecturer_1, 'JavaScript', 9)
student_2.rate_lecturer(lecturer_1, 'JavaScript', 10)
...
if lecturer_1 > lecturer_2:
    print(f'{"".join(lecturer_1.name)} {"".join(lecturer_1.surname)} преподает лучше чем {"".join(lecturer_2.name)} {"".join(lecturer_2.surname)}')
else:
    print(f'{"".join(lecturer_2.name)} {"".join(lecturer_2.surname)} преподает лучше чем {"".join(lecturer_1.name)} {"".join(lecturer_1.surname)}')
